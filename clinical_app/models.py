...
class PhysicalExamination(models.Model):
    ...
    examined_by = models.ForeignKey(Doctor, on_delete=models.SET_NULL, null=True, blank=True)
...
class LabTestResult(models.Model):
    ...
    performed_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, limit_choices_to={'user_type': 'lab_tech'})
...
class ImagingResult(models.Model):
    ...
    radiologist = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, limit_choices_to={'user_type': 'radiologist'})
...
class Prescription(models.Model):
    ...
    dispensed_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='medications_dispensed', limit_choices_to={'user_type': 'pharmacist'})
